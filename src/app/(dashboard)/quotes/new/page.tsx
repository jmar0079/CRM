    ...
    <form onSubmit={handleSubmit} className="space-y-6">
      <div className="grid gap-4 sm:grid-cols-2">
        ...
        <div className="space-y-1.5">
          ...
          <Input id="leadId" value={form.leadId} onChange={updateForm("leadId")} disabled={loading} placeholder="lead_…" />
        </div>
        <div className="space-y-1.5">
          <Label htmlFor="validUntil">Valid Until</Label>
          <Input id="validUntil" type="date" value={form.validUntil} onChange={updateForm("validUntil")} disabled={loading} />
        </div>
      </div>
